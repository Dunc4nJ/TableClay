...
function FreeShippingInline({
  ...
  return (
    <div className="bg-cream-100 p-2 rounded-lg border">
      <div className="space-y-1.5">
        ...
        <div className="flex justify-between gap-1">
          <div
            className={clx(
              "bg-gradient-to-r from-cream-300 to-cream-400 h-1 rounded-full max-w-full duration-500 ease-in-out",
              {
          ...
          ></div>
          <div className="bg-cream-400 h-1 rounded-full w-fit flex-grow"></div>
        </div>
      </div>
    </div>
  )
...
function FreeShippingPopup({
  ...
  return (
    ...
    >
      <div>
        <Button
          className="rounded-full bg-brand-800 shadow-none outline-none border-none text-[15px] p-2"
      ...
      <div className="w-[400px] bg-brand-900 text-white p-6 rounded-lg ">
        <div className="pb-4">
          <div className="space-y-3">
            <div className="flex justify-between text-[15px] text-cream-100">
              <div>
                {price.target_reached ? (
                  <div className="flex items-center gap-1.5">
                    <CheckCircleSolid className="text-green-500 inline-block" />{" "}
            ...
            <div className="flex justify-between gap-1">
              <div
                className={clx(
                  "bg-gradient-to-r from-cream-300 to-cream-400 h-1.5 rounded-full max-w-full duration-500 ease-in-out",
                  {
                    "from-green-400 to-green-500": price.target_reached,
                  }
                )}
                style={{ width: `${price.remaining_percentage}%` }}
              ></div>
              <div className="bg-cream-400 h-1.5 rounded-full w-fit flex-grow"></div>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-3">
          <LocalizedClientLink
            className="rounded-2xl bg-transparent shadow-none outline-none border-[1px] border-cream-200 text-[15px] py-2.5 px-4"
            href="/cart"
          >
            View cart
          </LocalizedClientLink>
          ...
          <LocalizedClientLink
            className="flex-grow rounded-2xl bg-ui-bg-component text-ui-fg-base shadow-none outline-none border-[1px] border-cream-200 text-[15px] py-2.5 px-4 text-center"
            href="/store"
          >
            View products
          </LocalizedClientLink>
